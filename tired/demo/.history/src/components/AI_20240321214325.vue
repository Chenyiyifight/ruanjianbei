    ...
    <div class="body">
        <div id="chat-container">
            ...
            <div id="chat-input">
                ...
                <button @click="sendMessage" id="sendButton" @keydown.enter.prevent="sendMessage">Send</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        async sendMessage() {
            var messageText = this.userMessage.trim();
            var sendButton = document.getElementById('sendButton');

            if (messageText !== "") {
                // Display user's message
                this.messages.push({ text: messageText, type: 'message sent' });
                ...
                try {
                    ...
                    this.messages.push({ text: aiResponse.data.result, type: 'message received' });
